...
#define SUBTITLE(x, y, z)                         \
    if (narationticks > x & narationticks <= y) { \
        l_text = sprintf(s_text, z);              \
    } else
...
void narrationsubtitles(void)
{
    ...
    switch (narration) {
        case 1:
            ...
            SUBTITLE(6500, 9000, "FOR YOUR COMFORT") if (narationticks > 12000) {
                narration = 0;
            }
        ...
        case 2:
            ...
            SUBTITLE(73000, 74500, "SIMULATION CHECKPOINT") if (narationticks > 77000) {
                narration = 0;
            }
        ...
        case 3:
            ...
            SUBTITLE(39300, 40300, "ON THAT LEVEL") if (narationticks > 45000) {
                narration = 0;
            }
        ...
        case 4:
            SUBTITLE(1000, 3000, "TUTORIAL STAGE IS OVER") if (narationticks > 4000) {
                narration = 0;
            }
        ...
        case 5: // intro
            ...
            */
            ...
            SUBTITLE(89300, 91300, "IS MADE OF ADAMANTIUM") if (narationticks > 135000) {
                narration = 0;
            }
...
void procnarration(void)
{
    ...
    if (narration) {
        ...
        /*
            zlColor4x(255,255,255,255);
            zlPush();
            zlTranslate(-60000,24000,0);
            zlScale(6000,10000,10000);
            l_text=sprintf(s_text,"[%i] %i",narration,narationticks);
            zlRenderText();
            zlPop();
        */
    }
