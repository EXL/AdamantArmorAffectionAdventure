    ...
    if (endlevel == 0) {
        if (loserwantexit > 0) {
            ...
            if (mobcontrol == 64) {
                ...
                if (button[0] == 1 | button[1] == 1 | button[2] == 1 | button[3] == 1 | button[8] == 1 | button[9] == 1
                    | mousetap == 1) {
            ...
            } else if (mob[mobcontrol][0] < 0) {
                firstperson = 0;
            } else {
                if (firstperson == 0) {
                    if (button[4] > 0) {
                        if (playeraim == 0) {
                            zcplaysound3d(16, 5, mob[mobcontrol][1], mob[mobcontrol][2], mob[mobcontrol][3] + 65536);
                        }
                ...
                if (playeraim == 16) {
                    ...
                    if (mob[mobcontrol][13] > 512) {
                        mob[mobcontrol][7] += mob[mobcontrol][13] - 512;
                        mob[mobcontrol][13] = 512;
                    } else if (mob[mobcontrol][13] < -256) {
                        mob[mobcontrol][7] += mob[mobcontrol][13] + 256;
                        mob[mobcontrol][13] = -256;
                    }

                    if (mob[mobcontrol][12] > 512) {
                        mob[mobcontrol][12] = 512;
                    } else if (mob[mobcontrol][12] < -512) {
                        mob[mobcontrol][12] = -512;
                    }
                    ...
                    if (firstperson == 1) {
                        ...
                        if (mob[mobcontrol][12] > 768) {
                            mob[mobcontrol][12] = 768;
                        } else if (mob[mobcontrol][12] < -768) {
                            mob[mobcontrol][12] = -768;
                        }
                    } else {
                    ...
                    if (firstperson == 0) {
                        if (mob[mobcontrol][36] == 0) {
                            if (mob[mobcontrol][37] == 0) {
                                if (mob[mobcontrol][38] == 0) {
                                    if (button[2] == 1) {
                                        mob[mobcontrol][36] = 64; // melee
                                    }

                                    if (button[3] == 1) {
                                        mob[mobcontrol][37] = 64; // scream
                                    }
                    ...
                    if (button[9] == 1) {
                        if (mob[mobcontrol][44] == 0) {
                            ...
                            mob[mobcontrol][44] = -mob[mobcontrol][44];
                        }
                    }
                    ...
                    if (mousebutton[0]) {
                        ...
                        if (mob[mobcontrol][13] > 512) {
                            mob[mobcontrol][13] = 512;
                        } else if (mob[mobcontrol][13] < -512) {
                            mob[mobcontrol][13] = -512;
                        }

                        if (mob[mobcontrol][12] > 256) {
                            mob[mobcontrol][12] = 256;
                        } else if (mob[mobcontrol][12] < -256) {
                            mob[mobcontrol][12] = -256;
                        }
                    } else {
...
void procautism(void)
{
    ...
    if (loserwantexit > 0) {
        ...
        if (button[4] > 0) {
            if (mob[mobcontrol][12] < 1024) {
                mob[mobcontrol][12] += 32;
            }
        }
        ...
        if (mousebutton[0]) {
            ...
            if (mob[mobcontrol][12] > 1024) {
                mob[mobcontrol][12] = 1024;
            } else if (mob[mobcontrol][12] < -1024) {
                mob[mobcontrol][12] = -1024;
            }
        } else {
            mob[mobcontrol][13] = mob[mobcontrol][13] * 9 / 10;
