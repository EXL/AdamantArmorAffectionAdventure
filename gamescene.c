...
{
    s32 cx, cy, cz, cx0, cx1, cy0, cy1, cz0, cz1, x, y, z;
    u8 l;
        ...
        for (y = cy0; y < cy1; y++)
            for (x = cx0; x < cx1; x++)
                if (mp[x][y][z][1] > 0)
                    switch (mp[x][y][z][1]) {
                    case 8:
                        newlight((x << 16) + 32768, (y << 16) + 32768, (z << 16) + 32768, (255) + (255 << 8) + (255 << 16) + (2 << 24));
                        break; //white light
                    case 9:
                        newlight((x << 16) + 32768, (y << 16) + 32768, (z << 16) + 32768, (255) + (0 << 8) + (0 << 16) + (2 << 24));
                        break; // light
                    case 10:
                        newlight((x << 16) + 32768, (y << 16) + 32768, (z << 16) + 32768, (0) + (255 << 8) + (0 << 16) + (2 << 24));
                        break; // light
                    case 11:
                        newlight((x << 16) + 32768, (y << 16) + 32768, (z << 16) + 32768, (0) + (0 << 8) + (255 << 16) + (2 << 24));
                        break; // light
                    case 12:
                        newlight((x << 16) + 32768, (y << 16) + 32768, (z << 16) + 32768, (255) + (255 << 8) + (0 << 16) + (2 << 24));
                        break; // light
                    case 13:
                        newlight((x << 16) + 32768, (y << 16) + 32768, (z << 16) + 32768, (0) + (255 << 8) + (255 << 16) + (2 << 24));
                        break; // light
                    case 14:
    ...
    if (howfar > 0)
        ...
        case 7: //water;
            ...
            if (b > 255)
                b = 255;
            zlColor4x(r, g, b, 255);
            zlTexCoord2x(wtx + 0, wty + 65535);
            zlVertex3x(((x + 0) << 16), ((z + 0) << 16) + wz[0], ((y + 0) << 16));
            if (mpc[x + 1][y][z]) {
                r = lightg[3];
                g = lightg[4];
                b = lightg[5];
            ...
            if (b > 255)
                b = 255;
            zlColor4x(r, g, b, 255);
            zlTexCoord2x(wtx + 65535, wty + 65535);
            zlVertex3x(((x + 1) << 16), ((z + 0) << 16) + wz[1], ((y + 0) << 16));
            if (mpc[x + 1][y + 1][z]) {
                r = lightg[3];
                g = lightg[4];
                b = lightg[5];
            ...
            lcuberead(x0 + 65536, y0 + 65536, z0);
            ir = lcuber[0];
            ig = lcuber[1];
            ib = lcuber[2];
            r += ir;
            ...
            if (b > 255)
                b = 255;
            zlColor4x(r, g, b, 255);
            zlTexCoord2x(wtx + 65536, wty + 0);
            zlVertex3x(((x + 1) << 16), ((z + 0) << 16) + wz[2], ((y + 1) << 16));
            if (mpc[x][y + 1][z]) {
                r = lightg[3];
                g = lightg[4];
                b = lightg[5];
            ...
            if (b > 255)
                b = 255;
            zlColor4x(r, g, b, 255);
            zlTexCoord2x(wtx, wty);
            zlVertex3x(((x + 0) << 16), ((z + 0) << 16) + wz[3], ((y + 1) << 16));
            zlEndQuads();
            break;
        ...
        case 24: //little stone
            ...
            zlVertex3x(x0 - sizex * mvx, y0 + 0, z0 - sizex * mvz);
            zlTexCoord2x(65536, 65536);
            zlVertex3x(x0 + sizex * mvx, y0 + 0, z0 + sizex * mvz);
            zlTexCoord2x(65536, 0);
            zlVertex3x(x0 + sizex * mvx, y0 + mvy * sizey, z0 + sizex * mvz);
            zlTexCoord2x(0, 0);
            zlVertex3x(x0 - sizex * mvx, y0 + mvy * sizey, z0 - sizex * mvz);
            zlEndQuads();
            break;
        ...
        case 40: //achievemnt1
            ...
            x0 = x * 65536 + 32768;
            y0 = z * 65536 + 32768 + f_sin[((count * 14) & 4095)] / 8;
            z0 = y * 65536 + 32768;
        ...
        case 41: //achievemnt1
            ...
            x0 = x * 65536 + 32768;
            y0 = z * 65536 + 32768 + f_sin[((count * 14 + 900) & 4095)] / 8;
            z0 = y * 65536 + 32768;
        ...
        case 42: //achievemnt1
            ...
            x0 = x * 65536 + 32768;
            y0 = z * 65536 + 32768 + f_sin[((count * 14 + 2000) & 4095)] / 8;
            z0 = y * 65536 + 32768;
        ...
        case 43: //achievemnt1
            ...
            x0 = x * 65536 + 32768;
            y0 = z * 65536 + 32768 + f_sin[((count * 14 + 3000) & 4095)] / 8;
            z0 = y * 65536 + 32768;
        ...
        case 44: //achievemnt1
            ...
            x0 = x * 65536 + 32768;
            y0 = z * 65536 + 32768 + f_sin[((count * 14 + 1024) & 4095)] / 8;
            z0 = y * 65536 + 32768;
                    ...
                    if (intrestingmp[x][y][z]) {
                        ...
                        if (cert[ix][iy][iz]) {
                            ...
                            if (z == cmapmaxy - 1)
                                ...
                                renderit = 0;
                            else if (mp[x][y][z + 1][0] > 0)
                                renderit = 0;
                            else if (mp[x][y][z + 1][1] == 7)
                                renderit = 0;
                            else if (scert[ix][iy][iz + 1] == 0 && scert[ix + 1][iy][iz + 1] == 0 && scert[ix][iy + 1][iz + 1] == 0 && scert[ix + 1][iy + 1][iz + 1] == 0)
                                renderit = 0;
                            else
                                /*
...
*/
                                ...
                                mesh[ii_m] = premesh[ix][iy][iz + 1][0];
                                mesh[ii_m + 1] = premesh[ix][iy][iz + 1][1];
                                mesh[ii_m + 2] = premesh[ix][iy][iz + 1][2];
                                meshc[ii_c] = precol[ix][iy][iz + 1][0];
                                meshc[ii_c + 1] = precol[ix][iy][iz + 1][1];
                                meshc[ii_c + 2] = precol[ix][iy][iz + 1][2];
                                meshc[ii_c + 3] = 255;
                                mesht[ii_t] = 0;
                                ii_t++;
                                mesht[ii_t] = 0;
                                ...
                                mesh[ii_m + 3] = premesh[ix + 1][iy][iz + 1][0];
                                mesh[ii_m + 4] = premesh[ix + 1][iy][iz + 1][1];
                                mesh[ii_m + 5] = premesh[ix + 1][iy][iz + 1][2];
                                meshc[ii_c + 4] = precol[ix + 1][iy][iz + 1][0];
                                meshc[ii_c + 5] = precol[ix + 1][iy][iz + 1][1];
                                meshc[ii_c + 6] = precol[ix + 1][iy][iz + 1][2];
                                meshc[ii_c + 7] = 255;
                                mesht[ii_t] = 65536;
                                ii_t++;
                                mesht[ii_t] = 0;
                                ...
                                mesh[ii_m + 6] = premesh[ix][iy + 1][iz + 1][0];
                                mesh[ii_m + 7] = premesh[ix][iy + 1][iz + 1][1];
                                mesh[ii_m + 8] = premesh[ix][iy + 1][iz + 1][2];
                                meshc[ii_c + 8] = precol[ix][iy + 1][iz + 1][0];
                                meshc[ii_c + 9] = precol[ix][iy + 1][iz + 1][1];
                                meshc[ii_c + 10] = precol[ix][iy + 1][iz + 1][2];
                                meshc[ii_c + 11] = 255;
                                mesht[ii_t] = 0;
                                ii_t++;
                                mesht[ii_t] = 65536;
                                ...
                                mesh[ii_m + 9] = mesh[ii_m + 6];
                                mesh[ii_m + 10] = mesh[ii_m + 7];
                                mesh[ii_m + 11] = mesh[ii_m + 8];
                                mesh[ii_m + 12] = mesh[ii_m + 3];
                                mesh[ii_m + 13] = mesh[ii_m + 4];
                                mesh[ii_m + 14] = mesh[ii_m + 5];

                                meshc[ii_c + 12] = meshc[ii_c + 8];
                                meshc[ii_c + 13] = meshc[ii_c + 9];
                                meshc[ii_c + 14] = meshc[ii_c + 10];
                                meshc[ii_c + 15] = meshc[ii_c + 11];
                                meshc[ii_c + 16] = meshc[ii_c + 4];
                                meshc[ii_c + 17] = meshc[ii_c + 5];
                                meshc[ii_c + 18] = meshc[ii_c + 6];
                                meshc[ii_c + 19] = meshc[ii_c + 7];
                                ...
                                mesh[ii_m + 15] = premesh[ix + 1][iy + 1][iz + 1][0];
                                mesh[ii_m + 16] = premesh[ix + 1][iy + 1][iz + 1][1];
                                mesh[ii_m + 17] = premesh[ix + 1][iy + 1][iz + 1][2];
                                meshc[ii_c + 20] = precol[ix + 1][iy + 1][iz + 1][0];
                                meshc[ii_c + 21] = precol[ix + 1][iy + 1][iz + 1][1];
                                meshc[ii_c + 22] = precol[ix + 1][iy + 1][iz + 1][2];
                                meshc[ii_c + 23] = 255;
                                mesht[ii_t] = 65536;
                                ii_t++;
                                mesht[ii_t] = 65536;
                            ...
                            if (z < 1)
                                ...
                                renderit = 0;
                            else if (scert[ix][iy][iz] == 0 && scert[ix + 1][iy][iz] == 0 && scert[ix][iy + 1][iz] == 0 && scert[ix + 1][iy + 1][iz] == 0)
                                renderit = 0;
                            else
                                /*
...
*/
                                ...
                                mesh[ii_m] = premesh[ix][iy][iz][0];
                                ii_m++;
                                mesh[ii_m] = premesh[ix][iy][iz][1];
                                ii_m++;
                                mesh[ii_m] = premesh[ix][iy][iz][2];
                                ii_m++;
                                meshc[ii_c] = precol[ix][iy][iz][0];
                                ii_c++;
                                meshc[ii_c] = precol[ix][iy][iz][1];
                                ii_c++;
                                meshc[ii_c] = precol[ix][iy][iz][2];
                                ii_c++;
                                meshc[ii_c] = 255;
                                ii_c++;
                                mesht[ii_t] = 0;
                                ...
                                mesh[ii_m] = premesh[ix + 1][iy][iz][0];
                                ii_m++;
                                mesh[ii_m] = premesh[ix + 1][iy][iz][1];
                                ii_m++;
                                mesh[ii_m] = premesh[ix + 1][iy][iz][2];
                                ii_m++;

                                meshc[ii_c] = precol[ix + 1][iy][iz][0];
                                ii_c++;
                                meshc[ii_c] = precol[ix + 1][iy][iz][1];
                                ii_c++;
                                meshc[ii_c] = precol[ix + 1][iy][iz][2];
                                ii_c++;
                                meshc[ii_c] = 255;
                                ii_c++;
                                mesht[ii_t] = 65536;
                            ...
                            if (y == cmapmaxh - 1)
                                ...
                                renderit = 0;
                            else if (mp[x][y + 1][z][0] > 0)
                                renderit = 0;
                            else if (scert[ix][iy + 1][iz] == 0 && scert[ix + 1][iy + 1][iz] == 0 && scert[ix + 1][iy + 1][iz + 1] == 0 && scert[ix][iy + 1][iz + 1] == 0)
                                renderit = 0;
                            else
                                /*
if (prec[ix][iy+1][iz]==0) renderit=0;else
...
*/
                                ...
                                mesh[ii_m++] = premesh[ix][iy + 1][iz + 1][0];
                                mesh[ii_m++] = premesh[ix][iy + 1][iz + 1][1];
                                mesh[ii_m++] = premesh[ix][iy + 1][iz + 1][2];
                                meshc[ii_c++] = precol[ix][iy + 1][iz + 1][0];
                                meshc[ii_c++] = precol[ix][iy + 1][iz + 1][1];
                                meshc[ii_c++] = precol[ix][iy + 1][iz + 1][2];
                                meshc[ii_c++] = 255;
                                mesht[ii_t++] = 0;
                                mesht[ii_t++] = 0;
                                ...
                                mesh[ii_m++] = premesh[ix + 1][iy + 1][iz + 1][0];
                                mesh[ii_m++] = premesh[ix + 1][iy + 1][iz + 1][1];
                                mesh[ii_m++] = premesh[ix + 1][iy + 1][iz + 1][2];
                                meshc[ii_c++] = precol[ix + 1][iy + 1][iz + 1][0];
                                meshc[ii_c++] = precol[ix + 1][iy + 1][iz + 1][1];
                                meshc[ii_c++] = precol[ix + 1][iy + 1][iz + 1][2];
                                meshc[ii_c++] = 255;
                                mesht[ii_t++] = 65536;
                                mesht[ii_t++] = 0;
                            ...
                            if (y < 1)
                                ...
                                renderit = 0;
                            else if (scert[ix][iy][iz] == 0 && scert[ix + 1][iy][iz] == 0 && scert[ix + 1][iy][iz + 1] == 0 && scert[ix][iy][iz + 1] == 0)
                                renderit = 0;
                            else
                                /*
if (prec[ix][iy][iz]==0) renderit=0;else
...
*/
                                ...
                                mesh[ii_m++] = premesh[ix][iy][iz + 1][0];
                                mesh[ii_m++] = premesh[ix][iy][iz + 1][1];
                                mesh[ii_m++] = premesh[ix][iy][iz + 1][2];
                                meshc[ii_c++] = precol[ix][iy][iz + 1][0];
                                meshc[ii_c++] = precol[ix][iy][iz + 1][1];
                                meshc[ii_c++] = precol[ix][iy][iz + 1][2];
                                meshc[ii_c++] = 255;
                                mesht[ii_t++] = 65536;
                                mesht[ii_t++] = 0;
                                ...
                                mesh[ii_m++] = premesh[ix + 1][iy][iz + 1][0];
                                mesh[ii_m++] = premesh[ix + 1][iy][iz + 1][1];
                                mesh[ii_m++] = premesh[ix + 1][iy][iz + 1][2];
                                meshc[ii_c++] = precol[ix + 1][iy][iz + 1][0];
                                meshc[ii_c++] = precol[ix + 1][iy][iz + 1][1];
                                meshc[ii_c++] = precol[ix + 1][iy][iz + 1][2];
                                meshc[ii_c++] = 255;
                                mesht[ii_t++] = 0;
                                mesht[ii_t++] = 0;
                            ...
                            if (x < 1)
                                ...
                                renderit = 0;
                            else if (mp[x - 1][y][z][0] > 0)
                                renderit = 0;
                            else if (scert[ix][iy][iz] == 0 && scert[ix][iy + 1][iz] == 0 && scert[ix][iy + 1][iz + 1] == 0 && scert[ix][iy][iz + 1] == 0)
                                renderit = 0;
                            else
                                /*
if (prec[ix][iy+1][iz]==0) renderit=0;else
...
*/
                            ...
                            if (x == cmapmaxh - 1)
                                ...
                                renderit = 0;
                            else if (scert[ix + 1][iy][iz] == 0 && scert[ix + 1][iy + 1][iz] == 0 && scert[ix + 1][iy + 1][iz + 1] == 0 && scert[ix + 1][iy][iz + 1] == 0)
                                renderit = 0;
                            else
                                /*
if (prec[ix+1][iy][iz]==0) renderit=0;else
            ...
            for (y = cy0; y < cy1; y++)
                for (x = cx0; x < cx1; x++)
                    if (mp[x][y][z][1] > 0) {
                        ...
                        zlTexCoord2x((dx + 0) * 8192, (dy + 0) * 8192);
                        zlVertex3x((x + 0) * 65536, (z + 0) * 65536 + 8192, (y + 0) * 65536);
                        zlTexCoord2x((dx + 1) * 8192, (dy + 0) * 8192);
                        zlVertex3x((x + 1) * 65536, (z + 0) * 65536 + 8192, (y + 0) * 65536);
                        zlTexCoord2x((dx + 1) * 8192, (dy + 1) * 8192);
                        zlVertex3x((x + 1) * 65536, (z + 0) * 65536 + 8192, (y + 1) * 65536);
                        zlTexCoord2x((dx + 0) * 8192, (dy + 1) * 8192);
                        zlVertex3x((x + 0) * 65536, (z + 0) * 65536 + 8192, (y + 1) * 65536);
                    }
        zlEndQuads();
    }
...
void rendersky(void)
{
    ...
    case 2: //blue sky
        ...
        zlTexCoord2x(x, 0);
        zlVertex3x(-88000, 8000, 70000);
        zlTexCoord2x((x + 65536), 0);
        zlVertex3x(88000, 8000, 70000);
        zlTexCoord2x((x + 65536), 65536);
        zlVertex3x(88000, -24000, 70000);
        zlTexCoord2x(x, 65536);
        zlVertex3x(-88000, -24000, 70000);
        zlEndQuads();
        zlPop();
        zlBlend(0);
...
void showfps(void)
{
    ...
    zlPush();
    zlTranslate(50000, 54000, 0);
    zlScale(6000, 10000, 10000);
    l_text = sprintf(s_text, "%i", fps);
    zlRenderText();
    zlPop();
}
...
void showinfo0(void)
{
    ...
    zlPush();
    zlTranslate(-60000, 54000, 0);
    zlScale(6000, 10000, 10000);
    l_text = sprintf(s_text, "F%i D%i P%i", meshcount / 3, frametime, debugprobe[2]);
    zlRenderText();
    zlPop();
}
        ...
        if (mob[i][0] > 0)
            if (mob[i][41] > 0 | i == mobcontrol) {
                ...
                case 0: //player
                    ...
                    k = k * 8;
                    if (k > 0)
                        newlight(mob[i][1] - (f_sin[mob[i][7]]) * 1 / 5, mob[i][2] - (f_cos[mob[i][7]]) * 1 / 5, mob[i][3] + 70536, (k) + (k << 8) + (k << 16) + (1 << 24));
                    break;
                case 2:
                    newlight(mob[i][1], mob[i][2], mob[i][3] + 32768, (32) + (255 << 8) + (32 << 16) + (1 << 24));
                    break; //slime
                case 5:
                    newlight(mob[i][1], mob[i][2], mob[i][3] + 65536, (255) + (255 << 8) + (32 << 16) + (1 << 24));
                    break; //ghoul
                }
            }
}
