...
void gamemenufront(void)
{
    ...
    zlVertex3x(-65536, 65536, 0);
    zlTexCoord2x(100, 65436);
    zlVertex3x(-65536, -65536, 0);
    zlTexCoord2x(65436, 65436);
    zlVertex3x(65536, -65536, 0);
    zlTexCoord2x(65436, 100);
    zlVertex3x(65536, 65536, 0);
    zlEndQuads();
...
void gameconfig(void)
{
    ...
    zlTexCoord2x(tx, ty);
    zlVertex3x(-65536, 65536, 0);
    zlTexCoord2x(tx + 65536, ty);
    zlVertex3x(65536, 65536, 0);
    zlTexCoord2x(tx + 65536, ty + 65536);
    zlVertex3x(65536, -65536, 0);
    zlTexCoord2x(tx, ty + 65536);
    zlVertex3x(-65536, -65536, 0);
    zlEndQuads();
    ...
    zlTexCoord2x(0, 65536);
    zlVertex3x(-65536, 65536, 0);
    zlTexCoord2x(65536, 65366);
    zlVertex3x(65536, 65536, 0);
    zlColor4x(255, 255, 255, 64);
    zlTexCoord2x(65536, 0);
    zlVertex3x(65536, 45536, 0);
    zlTexCoord2x(0, 0);
    zlVertex3x(-65536, 45536, 0);
