        ...
        if (sprite[i][0] > 0) {
            ...
            if (thisframenice)
                ...
                case 6: //note
                    ...
                    zlBindTexture(41);
                    if (sprite[i][6] == 0)
                        zlColor4x(0, 255, 255, 255);
                    else if (sprite[i][6] == 1)
                        zlColor4x(255, 0, 255, 255);
                    else if (sprite[i][6] == 2)
...
void spawnnewsprite(void)
{
    u8 i, k;
    i = 0;
    while ((sprite[i][0] > 0) & (i < 32))
        i++;
    if (i == 32)
        i = zlrand() / 8;
    for (k = 0; k < 8; k++)
        sprite[i][k] = sprite[32][k];
}
