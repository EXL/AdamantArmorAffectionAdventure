...
void camerastep(void)
{
    ...
    mm[2][1] = 0;
    mm[3][1] = 0;
    mm[0][2] = f_sin[camera[4]];
    mm[1][2] = 0;
    mm[2][2] = f_cos[camera[4]];
    mm[3][2] = 0;
    mm[0][3] = 0;
    mm[1][3] = 0;
    mm[2][3] = 0;
    ...
    mm[3][0] = 0;
    mm[0][1] = 0;
    mm[1][1] = f_cos[camera[3]];
    mm[2][1] = -f_sin[camera[3]];
    mm[3][1] = 0;
    mm[0][2] = 0;
    mm[1][2] = f_sin[camera[3]];
    mm[2][2] = f_cos[camera[3]];
    mm[3][2] = 0;
    mm[0][3] = 0;
    mm[1][3] = 0;
    mm[2][3] = 0;
    ...
    mm[2][0] = 0;
    mm[3][0] = 0;
    mm[0][1] = f_sin[camera[5]];
    mm[1][1] = f_cos[camera[5]];
    mm[2][1] = 0;
    mm[3][1] = 0;
    mm[0][2] = 0;
    mm[1][2] = 0;
