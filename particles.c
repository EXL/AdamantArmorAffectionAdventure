        ...
        if (pr[i][0] > 0) {
            if (thisframenice)
                ...
                case 0:
                    ...
                    zlTexCoord2x(0, 0);
                    zlVertex3x(pr[i][4] + vv[0][0], pr[i][5] + vv[0][1], pr[i][6] + vv[0][2]);
                    zlTexCoord2x(65536, 0);
                    zlVertex3x(pr[i][4] + vv[1][0], pr[i][5] + vv[1][1], pr[i][6] + vv[1][2]);
                    zlTexCoord2x(65536, 65536);
                    zlVertex3x(pr[i][4] + vv[2][0], pr[i][5] + vv[2][1], pr[i][6] + vv[2][2]);
                    zlTexCoord2x(0, 65536);
                    zlVertex3x(pr[i][4] + vv[3][0], pr[i][5] + vv[3][1], pr[i][6] + vv[3][2]);
            ...
            pr[i][0]--;
            if (-(FPML(pr[i][4] - camera[0], vcamera[2][0]) + FPML(pr[i][5] - camera[1], vcamera[2][1]) + FPML(pr[i][6] - camera[2], vcamera[2][2])) < 0)
                pr[i][0] = 0;
            ...
            if (x < 0)
                ...
                block = 1;
            else if (x >= mpheader[8])
                block = 1;
            else if (y >= mpheader[8])
                block = 1;
            else if (z >= mpheader[9])
                block = 1;
            else if (mp[x][y][z][0] > 0)
                block = 1;
